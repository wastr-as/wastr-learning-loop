...
| [0019](0019-signalr-hub-in-matching-extract-realtime-service.md) | SignalR hub currently lives in Matching — plan to extract a dedicated RealTime service | Accepted | – |
| [0020](0020-frontend-telemetry-build-time-injection.md) | Frontend (SPA) telemetry via build-time connection-string injection; dedicated App Insights for the global landing site | Accepted | – |
